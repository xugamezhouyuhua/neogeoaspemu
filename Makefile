TOOLCHAINDIR := /home/zhouyuhua/SNK_G1/static_SDL
BINPATH    := /opt/arm-2011.09/bin

LIBS += -static -s -L$(TOOLCHAINDIR)/lib -lSDL -lm -lpthread 

TARGET = mvsnjemu

INCS = -I./src -I$(TOOLCHAINDIR)/include -I$(TOOLCHAINDIR)/include/SDL
